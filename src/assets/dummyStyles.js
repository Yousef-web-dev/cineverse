...
export const navbarStyles = {
  ...
  logoutButton:
    "flex items-center gap-2 md:px-1.5 px-4 lg:px-4 xl:px-4 py-2 rounded-full bg-gradient-to-r from-gray-800 to-gray-900 text-white text-sm font-semibold border border-red-600/30 cursor-pointer transition-all duration-300 hover:from-red-700 hover:to-red-900 hover:border-red-500 hover:shadow-lg hover:shadow-red-900/40 hover:-translate-y-0.5",

  loginButton:
    "flex items-center gap-2 px-4 py-2 md:px-1.5 lg:px-4 xl:px-4 rounded-full bg-gradient-to-r from-red-300 to-red-700 text-white text-sm font-semibold border border-red-600/20 cursor-pointer transition-all duration-300 hover:from-red-600 hover:to-red-800",
  authIcon: "h-4 w-4",
  ...
  mobileMenuPanel:
    "md:hidden absolute left-4 right-4 top-full mt-6 bg-black backdrop-blur-md rounded-2xl p-4 shadow-xl transition-all duration-300 ease-in-out transform origin-top",
  ...
  mobileLogoutButton:
    "w-full mt-3 px-4 py-3 rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 text-white flex items-center justify-center gap-2 cursor-pointer transition-all duration-300 hover:from-red-700 hover:to-red-900 hover:border-red-500",
  mobileLoginButton:
    "w-full mt-3 px-4 py-3 rounded-xl bg-gradient-to-r from-red-600 to-red-500 text-white flex items-center justify-center gap-2 cursor-pointer transition-all duration-300 hover:from-red-700 hover:to-red-600",
  mobileAuthIcon: "h-5 w-5",
};

// CSS styles for the style block
...
export const footerStyles = {
  ...
  gridContainer:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-12 md:mb-16",
  ...
  scrollTopButton: {
    base: "fixed bottom-4 sm:bottom-6 right-4 sm:right-6 cursor-pointer bg-red-700 hover:bg-red-600 text-white p-3 sm:p-4 rounded-full shadow-lg border border-red-500 transition-all duration-500 ease-in-out transform z-20 group hover:-translate-y-1 active:scale-95",
    visible: "opacity-100 translate-y-0 pointer-events-auto",
    hidden: "opacity-0 translate-y-6 pointer-events-none",
  },
  scrollTopIcon:
    "h-5 w-5 sm:h-6 sm:w-6 transition-transform duration-300 group-hover:-translate-y-0.5",
...
export const releasesStyles = {
  ...
  imageContainer: "relative overflow-hidden rounded-lg shadow-lg",
  movieImage:
    "w-full h-72 object-cover transition-transform duration-700 group-hover:scale-105",

  // Overlay effect
  overlay:
    "absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4",

  // Movie info
  movieInfo: "mt-3 font-[pacifico]",
  movieTitle: "text-base sm:text-lg font-bold text-white truncate",
  categoryContainer: "flex items-center justify-between mt-1",
  categoryText: "text-xs text-red-400 font-semibold capitalize",
  releaseDate: "text-xs text-gray-400",

  // Badge
  badge:
    "absolute top-3 right-3 bg-red-600/90 text-white text-xs px-2.5 py-1 rounded-full font-bold backdrop-blur-sm border border-red-400/30 shadow-md",
};
// Add to src/assets/dummyStyles.js
...
export const signUpStyles = {
  ...
  // Back button
  // داخل signUpStyles أو loginStyles في ملف dummyStyles.js

  backButton:
    "mb-4 inline-flex items-center text-red-400 hover:text-red-300 transition-all duration-300 group cursor-pointer focus:outline-none self-start",

  backIcon:
    "h-5 w-5 transform group-hover:-translate-x-1 transition-transform duration-200",

  backText: "ml-2 text-sm font-semibold tracking-wider font-cinema",
  // Card
