...
const movies = [
...

  {
    ...
    price: 180,
    synopsis:
      "A family drama with warm humor — traditions, rivalries and a big wedding plan that changes lives.",
...

  {
    ...
    price: 220,
    synopsis:
      "A relentless action-packed thriller where an ex-commando takes on powerful adversaries in a fight for justice.",
...

  {
    ...
    price: 240,
    synopsis:
      "A visceral folk-driven tale of land, tradition and survival; raw performances and immersive visuals.",
...

  {
    ...
    price: 200,
    synopsis:
      "A colorful romantic drama about self-discovery, modern love and cultural celebration.",
...

  {
    ...
    price: 210,
    synopsis:
      "A taut crime thriller that follows a small-town cop as he uncovers a deep-rooted conspiracy.",
