            ...
            <div className={trailersStyles.leftCard}>
              ...
              <div className={trailersStyles.carouselControls}>
                <div className={trailersStyles.controlButtons}>
                  <button
                    onClick={scrollLeft}
                    className={`${trailersStyles.controlButtons} p-2 rounded-full transition-all duration-300 hover:bg-red-600 hover:text-white hover:border-red-500 hover:scale-110 hover:shadow-[0_0_12px_rgba(239,68,68,0.5)] active:scale-95 cursor-pointer`}
              ...
              <div className={trailersStyles.trendingSection}>
                ...
                {trailersData.slice(3, 6).map((trailer) => (
                  <div
          ...
          <div className={trailersStyles.rightSide}>
            <div className={trailersStyles.rightCard}>
              <div className={trailersStyles.videoContainer}>
                {isPlaying ? (
                  <div className={trailersStyles.videoIframe}>
                    <iframe
