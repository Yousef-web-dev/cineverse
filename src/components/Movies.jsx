...
// import movies from "../assets/moviesData"; // ✅ مصدر موحّد لكل الأفلام
import { Link } from "react-router-dom";
import { Tickets } from "lucide-react";

const Movies = () => {
  // نعرض تحديداً أفلام "New Releases" (اللي كانت في dummyrdata سابقاً)
  // لو مفيش، بنرجع لأول 6 أفلام من القايمة الكاملة كـ fallback
  const newReleases = movies.filter((m) => m.isNewRelease);
  const visibleMovies = (newReleases.length ? newReleases : movies);
  return (
